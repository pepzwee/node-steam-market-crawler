...
SteamCrawler.prototype.getListings = function(appID, market_hash_name, loadAdditionalEndpoints, callback) {
    if(typeof loadAdditionalEndpoints === "function") {
        callback = loadAdditionalEndpoints;
        loadAdditionalEndpoints = false;
    }
    ...
    this.request(url, (err, data) => {
        if(err) {
            ...
            return callback(null, new MarketItem($, loadAdditionalEndpoints));
        }
    });
}
